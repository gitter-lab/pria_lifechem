...
#         print name, continuous_data[continuous_data['Molecule'] == name]['Keck_Pria_Continuous']
#         print name, updated_binary_label[updated_binary_label['Molecule'] == name]['Keck_Pria_AS_Retest']
