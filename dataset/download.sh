#!/usr/bin/env bash
wget https://zenodo.org/record/1257463/files/pria_rmi_cv.tar.gz
wget https://zenodo.org/record/1257463/files/pria_rmi_pcba_cv.tar.gz
wget https://zenodo.org/record/1257463/files/pria_prospective.csv.gz
