...
def get_top_mm_models(gather_df,
                      col_indices=list(range(10)) + list(range(15, 20)) + list(range(25, 65)) + list(
                          range(145, 149)) + list(range(150, 180)),
                      N=5):
...
def get_spearman_r(agg_comp_dict, metric_names, n_hits_metrics,
